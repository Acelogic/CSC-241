...
public class Handler extends DefaultHandler {
    ...
    private ArrayList<Product> globalProductList = new ArrayList<>();
        ...
        switch (qName) {
            ...
            case "product":
                ...
                if (taxable) {
                    ...
                    globalProductList.add(new Taxable(productName, isbn, unitPrice, quantity));

                } else {
                    tempProductList.add(new NonTaxable(productName, isbn, unitPrice, quantity));
                    globalProductList.add(new NonTaxable(productName, isbn, unitPrice, quantity));
                }
                break;
    ...
    public HashMap<String, Product> getDatabase() {
        ...
        for (Product p : globalProductList) {
            database.put(p.getISBN(), p);
        }
